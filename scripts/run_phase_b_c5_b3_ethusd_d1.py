"""Pivot v4 Phase B C5 â€” B3 : ETHUSD D1 walk-forward simple (sans mÃ©ta-labeling).

Flow simplifiÃ© :
1. Charge ETHUSD D1, cutoff train â‰¤ 2022-12-31, test â‰¥ 2024-01-01.
2. Construit le superset de features, sÃ©lectionne le top 15 C5 pour ETHUSD D1.
3. GÃ©nÃ¨re la target Donchian (N=20, M=20) sur train â†’ backtest â†’ trades binaires
   (winner = pips_net > 0).
4. EntraÃ®ne hgbm (hyperparams C5) sur les features aux barres d'entrÃ©e des trades train.
...
8. Sauvegarde dans predictions/phase_b_c5_b3_ethusd_d1.json.
...
def _build_features_for_split(df_split: pd.DataFrame) -> pd.DataFrame:
    """Construit le superset et sÃ©lectionne le top 15 C5 pour ETHUSD D1."""
...
def _train_hgbm_model(
    ...
    """EntraÃ®ne le modÃ¨le hgbm avec les hyperparams C5 pour ETHUSD D1."""
...
def main() -> int:
    ...
    # â”€â”€ 1. Chargement ETHUSD D1 â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    print(f"\nEntraÃ®nement hgbm sur {len(X_train)} trades train...")
    ...
    print(f"\n{'='*60}")
    print(f"Phase B C5 â€” B3 ETHUSD D1 terminÃ©.")
    ...
    out: dict[str, Any] = {
        "hypothesis": "B3_C5_ETHUSD_D1",
        "phase": "Phase B C5 â€” B3",
        "asset": ASSET,
        "tf": TF,
        "model": "hgbm",
    ...
    out_path = Path("predictions/phase_b_c5_b3_ethusd_d1.json")
