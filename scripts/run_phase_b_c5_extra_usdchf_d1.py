"""Pivot v4 Phase B C5 Extra â€” USDCHF D1 walk-forward simple (sans mÃ©ta-labeling).

Flow simplifiÃ© :
1. Charge USDCHF D1, cutoff train â‰¤ 2022-12-31, test â‰¥ 2024-01-01.
2. Construit le superset de features, sÃ©lectionne le top 15 C5 pour USDCHF D1.
...
8. Sauvegarde dans predictions/phase_b_c5_extra_usdchf_d1.json.
...
def _build_features_for_split(df_split: pd.DataFrame) -> pd.DataFrame:
    """Construit le superset et sÃ©lectionne le top 15 C5 pour USDCHF D1."""
...
def main() -> int:
    ...
    # â”€â”€ 1. Chargement USDCHF D1 â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    print(f"\n{'='*60}")
    print(f"Phase B C5 Extra â€” USDCHF D1 terminÃ©.")
    ...
    out_path = Path("predictions/phase_b_c5_extra_usdchf_d1.json")
