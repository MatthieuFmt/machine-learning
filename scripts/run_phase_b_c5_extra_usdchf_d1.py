"""Pivot v4 Phase B C5 Extra — USDCHF D1 walk-forward simple (sans méta-labeling).

Flow simplifié :
1. Charge USDCHF D1, cutoff train ≤ 2022-12-31, test ≥ 2024-01-01.
2. Construit le superset de features, sélectionne le top 15 C5 pour USDCHF D1.
...
def _build_features_for_split(df_split: pd.DataFrame) -> pd.DataFrame:
    """Construit le superset et sélectionne le top 15 C5 pour USDCHF D1."""
...
def main() -> int:
    ...
    print(f"\n{'='*60}")
    print(f"Phase B C5 Extra — USDCHF D1 terminé.")
