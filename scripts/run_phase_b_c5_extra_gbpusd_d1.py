"""Pivot v4 Phase B C5 Extra â€” GBPUSD D1 walk-forward simple (sans mÃ©ta-labeling).

Flow simplifiÃ© :
1. Charge GBPUSD D1, cutoff train â‰¤ 2022-12-31, test â‰¥ 2024-01-01.
2. Construit le superset de features, sÃ©lectionne le top 15 C5 pour GBPUSD D1.
...
8. Sauvegarde dans predictions/phase_b_c5_extra_gbpusd_d1.json.
...
def _build_features_for_split(df_split: pd.DataFrame) -> pd.DataFrame:
    """Construit le superset et sÃ©lectionne le top 15 C5 pour GBPUSD D1."""
...
def _train_rf_model(
    ...
    """EntraÃ®ne le modÃ¨le RandomForest avec les hyperparams C5 pour GBPUSD D1."""
...
def _generate_model_signals(
    ...
    La direction provient EXCLUSIVEMENT du signal primaire (Donchian).
    Le modÃ¨le ne fait que rejeter ou conserver, jamais dÃ©cider de la direction.
    """
...
def main() -> int:
    ...
    # â”€â”€ 1. Chargement GBPUSD D1 â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # Fix F1 : signaux primaires Donchian sur test, puis mÃ©ta-filtrage
    ...
    print(f"\n{'='*60}")
    print(f"Phase B C5 Extra â€” GBPUSD D1 terminÃ©.")
    ...
    out_path = Path("predictions/phase_b_c5_extra_gbpusd_d1.json")
