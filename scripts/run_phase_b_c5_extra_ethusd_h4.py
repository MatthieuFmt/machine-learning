"""Pivot v4 Phase B C5 Extra â€” ETHUSD H4 walk-forward simple (sans mÃ©ta-labeling).

Flow simplifiÃ© :
1. Charge ETHUSD H4, cutoff train â‰¤ 2022-12-31, test â‰¥ 2024-01-01.
2. Construit le superset de features, sÃ©lectionne le top 15 C5 pour ETHUSD H4.
...
8. Sauvegarde dans predictions/phase_b_c5_extra_ethusd_h4.json.
...
def _build_features_for_split(df_split: pd.DataFrame) -> pd.DataFrame:
    """Construit le superset et sÃ©lectionne le top 15 C5 pour ETHUSD H4."""
...
def _train_hgbm_model(
    ...
    """EntraÃ®ne le modÃ¨le hgbm avec les hyperparams C5 pour ETHUSD H4."""
...
def main() -> int:
    ...
    # â”€â”€ 1. Chargement ETHUSD H4 â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    print(f"\n{'='*60}")
    print(f"Phase B C5 Extra â€” ETHUSD H4 terminÃ©.")
    ...
    out_path = Path("predictions/phase_b_c5_extra_ethusd_h4.json")
