...
**Dernière mise à jour** : 2026-08-06 (re-mesure finale sur bougies des 2 derniers candidats : **pre-FOMC et pre-ECB = NO-GO**. Le projet n'a plus AUCUN signal survivant. Données H1 + calendrier économique désormais VERSIONNÉS → les screens tournent en session.)
